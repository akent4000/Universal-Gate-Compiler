...
from ..core.expr             import Lit, Not, Expr
from ..core.implicant        import (Implicant, espresso, implicants_to_expr,
                                     int_to_bits, _expand_cubes_to_set)
from ..synthesis.optimize      import phase_assign, factorize, apply_shannon, elim_inv
from ..synthesis.decomposition import ashenhurst_decompose
from ..mapping.nand            import NANDBuilder, eval_network, nand_gate_count
...
def run_tests(tt: TruthTable, result: OptimizeResult,
    ...
    def _count_with(cls):
        ...
        from ..mapping.nand import dead_code_elimination
